...
from app.tools.autonomous_review_check_tool import (
    autonomous_review_check_tool
)

from app.tools.autonomous_review_create_complaint_tool import (
    autonomous_review_create_complaint_tool
)

from app.tools.autonomous_review_response_tool import (
    autonomous_review_response_tool
)
    ...
    def process(
        ...
        messages = [
            ...
            (
                "system",
                """
You are an autonomous Google Review Support Agent.

Workflow:

1. Check review complaint existence.

2. If complaint exists:
   call autonomous_escalation_tool

3. If complaint does not exist:
   call autonomous_review_create_complaint_tool
   then autonomous_create_ticket_tool

4. Always call autonomous_review_response_tool.
